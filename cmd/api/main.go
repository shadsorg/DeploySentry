...
import (
	...
	"github.com/shadsorg/deploysentry/internal/appstatus"
	...
	"github.com/shadsorg/deploysentry/internal/health/integrations"
	...
	"github.com/shadsorg/deploysentry/internal/platform/database"
	...
	"github.com/shadsorg/deploysentry/internal/rollback"
	...
	applicatordeploy "github.com/shadsorg/deploysentry/internal/rollout/applicator/deploy"
	rolloutengine "github.com/shadsorg/deploysentry/internal/rollout/engine"
	"github.com/shadsorg/deploysentry/internal/settings"
...
func run() error {
	...
	// Retention sweep: tombstones archived flags whose delete_after has elapsed.
	// Default: scan every 6h with a 30-day archive→tombstone window. Operators
	// opt flags into this via POST /flags/:id/queue-deletion.
