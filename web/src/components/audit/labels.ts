...
export function actionLabel(entry: AuditLogEntry): string {
  switch (entry.action) {
    ...
    case 'flag.updated.reverted':
      return 'Reverted: Updated flag';
    case 'flag.archived.reverted':
      return 'Reverted: Archived flag';
    case 'flag.toggled.reverted':
      return 'Reverted: Toggled flag';
    case 'flag.rule.created.reverted':
      return 'Reverted: Added rule';
    case 'flag.rule.deleted.reverted':
      return 'Reverted: Removed rule';
    case 'flag.rule.env_state.updated.reverted':
      return 'Reverted: Changed rule env state';
    case 'flag.env_state.updated.reverted':
      return 'Reverted: Changed env default value';
