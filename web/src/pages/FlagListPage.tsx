...
export default function FlagListPage() {
  ...
  // Performance Optimization: Wrap filter logic in useMemo to prevent O(N) operations on every render.
  // Also hoist the search string lowercase conversion out of the loop.
