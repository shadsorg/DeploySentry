        ...
        <>
          ...
          <div className="bento-grid">
            <div className="bento-card">
              ...
              <p>
                Define groups by rule sets — env, region, customer tier — so rollouts ride the same
                membership logic as your flags.
              </p>
            </div>
            <div className="bento-card">
              ...
              <p>
                Coordinate phased rollouts across siblings. Pause or cascade-abort the whole group
                when one app trips a guardrail.
              </p>
            </div>
            <div className="bento-card">
              ...
              <p>
                Group membership is delivered to clients via the same SDKs that already evaluate
                flags — no new wiring required.
              </p>
            </div>
          </div>
        </>
                  ...
                  <tr key={g.id}>
                    <td>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <Link
                          to={`/orgs/${orgSlug}/rollout-groups/${g.id}`}
                    ...
                    <td>
                      <span className="badge badge-ops">{g.coordination_policy}</span>
                    </td>
