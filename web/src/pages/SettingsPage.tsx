...
const SettingsPage: React.FC<SettingsPageProps> = ({ level = 'org', tab }) => {
  ...
  // handleSoftDeleteProject and handleHardDeleteProject functions removed as they are unimplemented and cause compilation errors.

  // handleHardDeleteProject function removed as it is unimplemented and causes compilation errors.
